...
##### read consensus tree
phy <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/kuntner_lbs_reltime_trees/final_lbs_tree_rooted_no_outgroup_names_edited.nwk")
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/kuntner_lbs_reltime_trees/lbs_rt_divtimes.nwk")

all_times = matrix(NA, ncol=400, nrow=30)
plot(phy)
nodelabels()
#edgelabels()
##### get root height
...
estimated_times <- c(ta32,ta33,ta34,ta35,ta36,ta37,ta38,ta39,ta40,ta41,ta42,ta43,ta44,ta45,ta46,ta47,ta48,ta49,ta50,ta51,ta52,ta53,ta54,ta55,ta56,ta57,ta58,ta59,ta60,ta61)
...
df <- data.frame(c(32:61))
newname <- c("node")
colnames(df) <- newname
df1 <- cbind(df, all_times)
df1 <- data.frame(df1)

dfm <- data.frame(c(rowMeans(df1[1:30, 2:401])))
newname <- c("mean_time")
...
write.table(df1, file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/kuntner_lbs_reltime_trees/mrca_divtimes.txt", sep="\t", col.names=NA)
