...
require(ape)
require(phytools)
b <- read.tree(file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/kuntner_lbs_reltime_trees/final_lbs_tree_rooted.nwk")
b <- drop.tip(b, "I13182_AUMS16046_Araneae_Mimetidae_Mimetus_puritans_seq1")
write.tree(b, file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/kuntner_lbs_reltime_trees/final_lbs_tree_rooted_no_outgroup.nwk")
############################################################
############################################################
