...
##### read consensus tree
phy <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/sann_lbs_reltime_trees_calibrated/final_lbs_tree_rooted_no_outgroup.nwk")
##### read 100 trees
phys <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/sann_lbs_reltime_trees_calibrated/lbs_rt_divtimes.nwk")

all_times = matrix(NA, ncol=100, nrow=175)
plot(phy)
nodelabels()
#edgelabels()
##### get root height
...
ta177 <- (findMRCA(phys[[i]],tips=n177, type="height")-rh2)*-1
ta178 <- (findMRCA(phys[[i]],tips=n178, type="height")-rh2)*-1
ta179 <- (findMRCA(phys[[i]],tips=n179, type="height")-rh2)*-1
ta180 <- (findMRCA(phys[[i]],tips=n180, type="height")-rh2)*-1
ta181 <- (findMRCA(phys[[i]],tips=n181, type="height")-rh2)*-1
ta182 <- (findMRCA(phys[[i]],tips=n182, type="height")-rh2)*-1
ta183 <- (findMRCA(phys[[i]],tips=n183, type="height")-rh2)*-1
ta184 <- (findMRCA(phys[[i]],tips=n184, type="height")-rh2)*-1
ta185 <- (findMRCA(phys[[i]],tips=n185, type="height")-rh2)*-1
ta186 <- (findMRCA(phys[[i]],tips=n186, type="height")-rh2)*-1
ta187 <- (findMRCA(phys[[i]],tips=n187, type="height")-rh2)*-1
ta188 <- (findMRCA(phys[[i]],tips=n188, type="height")-rh2)*-1
...
write.table(df1, file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/sann_lbs_reltime_trees_calibrated/mrca_divtimes.txt", sep="\t", col.names=NA)
