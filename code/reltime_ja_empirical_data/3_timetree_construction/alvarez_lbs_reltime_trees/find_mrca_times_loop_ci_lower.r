...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/alvarez_lbs_reltime_trees/lbs_rt_lower.nwk")
...
write.table(df1, file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/alvarez_lbs_reltime_trees/mrca_ci_lower.txt", sep="\t", col.names=NA)
