...
require(ape)
require(phytools)
b <- read.tree(file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/johnson_lbs_reltime_trees/final_lbs_tree_rooted.nwk")
b <- drop.tip(b, "Eurylophella_sp")
write.tree(b, file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/johnson_lbs_reltime_trees/final_lbs_tree_rooted_no_outgroup.nwk")
############################################################
############################################################
...
require(ape)
require(phytools)
b <- read.tree(file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/sann_lbs_reltime_trees/final_lbs_tree_rooted.nwk")
b <- drop.tip(b, "Harpegnathos_saltator")
write.tree(b, file = "/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/sann_lbs_reltime_trees/final_lbs_tree_rooted_no_outgroup.nwk")
############################################################
############################################################
