...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/johnson_lbs_reltime_trees/lbs_rt_divtimes.nwk")
...
write.table(df1, file="/Users/barba/Desktop/lbs_iqtree_reltime_timetrees/lbs-reltime_ultimate_timetrees/johnson_lbs_reltime_trees/mrca_divtimes.txt", sep="\t", col.names=NA)
