...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/jb_lbstt_cis_ar15/ar15_FINAL_sample_blens_timetrees_divtimes_pruned.nwk")
...
write.table(all_times, file="/Users/barba/Desktop/jb_lbstt_cis_ar15/ar15_mrca_times_divtimes.txt", sep="\t", col.names=NA)
