...
##### read consensus tree
phy <- read.tree(file="/Users/barba/Desktop/jb_lbstt_cis_ar2/ar2_FINAL_timetree_no_outgroup.nwk")
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/jb_lbstt_cis_ar2/ar2_FINAL_sample_blens_timetrees_divtimes_pruned.nwk")
...
write.table(all_times, file="/Users/barba/Desktop/jb_lbstt_cis_ar2/ar2_mrca_times_divtimes.txt", sep="\t", col.names=NA)
