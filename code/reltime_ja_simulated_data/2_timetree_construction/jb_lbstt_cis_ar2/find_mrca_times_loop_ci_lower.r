...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/jb_lbstt_cis_ar2/ar2_FINAL_sample_blens_timetrees_ci-lower_pruned.nwk")
...
write.table(all_times, file="/Users/barba/Desktop/jb_lbstt_cis_ar2/ar2_mrca_times_ci_lower.txt", sep="\t", col.names=NA)
