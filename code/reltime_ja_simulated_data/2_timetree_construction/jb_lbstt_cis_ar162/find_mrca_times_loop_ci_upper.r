...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/jb_lbstt_cis_ar162/ar162_FINAL_sample_blens_timetrees_ci-upper_pruned.nwk")
...
write.table(all_times, file="/Users/barba/Desktop/jb_lbstt_cis_ar162/ar162_mrca_times_ci_upper.txt", sep="\t", col.names=NA)
