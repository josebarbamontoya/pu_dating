...
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/top_rf_data_analysis/reltime_analyses/reltime_joint2/bs_timetree_construction_ar389/ouput_FINAL_sample_blens_timetrees_divtimes_pruned.nwk")
