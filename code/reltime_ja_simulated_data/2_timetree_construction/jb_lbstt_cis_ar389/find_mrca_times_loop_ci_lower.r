...
##### read consensus tree
phy <- read.tree(file="/Users/barba/Desktop/top_rf_data_analysis/reltime_analyses/reltime_joint2/bs_timetree_construction_ar389/out_389_FINAL_timetree_no_outgroup.nwk")
##### read 300 trees
phys <- read.tree(file="/Users/barba/Desktop/top_rf_data_analysis/reltime_analyses/reltime_joint2/bs_timetree_construction_ar389/ouput_FINAL_sample_blens_timetrees_ci-lower_pruned.nwk")
...
write.table(all_times, file="/Users/barba/Desktop/top_rf_data_analysis/reltime_analyses/reltime_joint2/bs_timetree_construction_ar389/ar163_mrca_times_ci_lower.txt", sep="\t", col.names=NA)
